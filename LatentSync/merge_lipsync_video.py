...
if __name__ == "__main__":
    ...
    inputs = [
        ...
        f'{lipsync_clip_path}/lipsync_clip_1_01_draw_cards.mp4',
        f'{lipsync_clip_path}/lipsync_clip_1_02_open_cards.mp4',
        f'{lipsync_clip_path}/lipsync_clip_1_03_collect_cards.mp4',
        f'{lipsync_clip_path}/lipsync_clip_game_start.mp4',
        f'{lipsync_clip_path}/lipsync_clip_loop.mp4',
        f'{lipsync_clip_path}/lipsync_clip_2_01_draw_cards.mp4',
        f'{lipsync_clip_path}/lipsync_clip_2_02_open_cards.mp4',
        f'{lipsync_clip_path}/lipsync_clip_2_03_collect_cards.mp4',
        f'{lipsync_clip_path}/lipsync_clip_game_start.mp4',
        f'{lipsync_clip_path}/lipsync_clip_loop.mp4',
        f'{lipsync_clip_path}/lipsync_clip_3_01_draw_cards.mp4',
        f'{lipsync_clip_path}/lipsync_clip_3_02_open_cards.mp4',
        f'{lipsync_clip_path}/lipsync_clip_3_03_collect_cards.mp4',
        f'{lipsync_clip_path}/lipsync_clip_game_start.mp4',
        f'{lipsync_clip_path}/lipsync_clip_loop.mp4',
        f'{lipsync_clip_path}/lipsync_clip_4_01_draw_cards.mp4',
        f'{lipsync_clip_path}/lipsync_clip_4_02_open_cards.mp4',
        f'{lipsync_clip_path}/lipsync_clip_4_03_collect_cards.mp4',
    ]

    output_dir = root_path / "final"
    output_dir.mkdir(parents=True, exist_ok=True)
    output_path = output_dir / "lipsync_clip_final.mp4"
    merge_mp4(inputs, output_path, mode="safe", crf=14, preset="medium", include_audio=True)